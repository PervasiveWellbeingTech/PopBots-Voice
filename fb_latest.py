...
fb_intruction = ['change bot', 'restart', 'worst case', 'problem solving', 'positive thinking', 'humor', 'relaxation', 'self love', 'distraction', 'introduce']
...
class FBClientBot(Client):
    ...
    def read_receive_buffer(self, thread_id):
        ...
        while True:
            ...
            if transcript_text.lower() == 'stephanie':
...
if __name__ == '__main__':
    ...
    password = "carla2019" # your facebook password
